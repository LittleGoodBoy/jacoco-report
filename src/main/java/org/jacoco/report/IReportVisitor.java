...
/**
 * Interface for all implementations to retrieve structured org.jacoco.report data. Unlike
...
public interface IReportVisitor extends IReportGroupVisitor {
	...
	/**
	 * Initializes the org.jacoco.report with global information. This method has to be
	 * called before any other method can be called.
	 * 
	 * @param sessionInfos
	 *            list of chronological ordered {@link SessionInfo} objects
	 *            where execution data has been collected for this org.jacoco.report.
	 * @param executionData
	 *            collection of all {@link ExecutionData} objects that are
	 *            considered for this org.jacoco.report
	 * @throws IOException
	...
	/**
	 * Has to be called after all org.jacoco.report data has been emitted.
	 * 
	 * @throws IOException
	 *             in case of IO problems with the org.jacoco.report writer
	 */
