...
public class CSVFormatter {
	...
	/**
	 * Returns the language names call-back used in this org.jacoco.report.
	 * 
	...
	/**
	 * Creates a new visitor to write a org.jacoco.report to the given stream.
	 * 
	 * @param output
	 *            output stream to write the org.jacoco.report to
	...
	public IReportVisitor createVisitor(final OutputStream output)
		...
		class Visitor extends CSVGroupHandler implements IReportVisitor {
			...
			public void visitInfo(final List<SessionInfo> sessionInfos,
					...
					throws IOException {
				// Info not used for CSV org.jacoco.report
			}
