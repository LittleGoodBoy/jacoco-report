...
public class HTMLFormatter implements IHTMLReportContext {
	...
	/**
	 * Sets the locale used for org.jacoco.report rendering. The current default locale is
	 * used by default.
	 * 
	 * @param locale
	 *            locale used for org.jacoco.report rendering
	 */
	...
	/**
	 * Creates a new visitor to write a org.jacoco.report to the given output.
	 * 
	 * @param output
	 *            output to write the org.jacoco.report to
	 * @return visitor to emit the org.jacoco.report data to
	 * @throws IOException
