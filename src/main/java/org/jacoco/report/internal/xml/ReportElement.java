...
public class ReportElement extends XMLElement {
	...
	private static final String SYSTEM = "org.jacoco.report.dtd";

	/**
	 * Creates a <code>org.jacoco.report</code> root element for a XML org.jacoco.report.
	 * 
	 * @param name
	...
	public ReportElement(final String name, final OutputStream output,
		...
		super("org/jacoco/report", PUBID, SYSTEM, true, encoding, output);
		attr("name", name);
	}
