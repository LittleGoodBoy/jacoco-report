...
/**
 * Static resource that are included with the coverage org.jacoco.report and might be
...
public class Resources {
	...
	/**
	 * Attaches resources to the org.jacoco.report with the given root folder.
	 *
	 * @param root
	 *            root folder of the org.jacoco.report
	 */
	...
	/**
	 * Copies all static resources into the org.jacoco.report.
	 *
	 * @throws IOException
	 *             if the resources can't be written to the org.jacoco.report
	 */
