 ...
 * breadcrumb, the title and the footer. Every org.jacoco.report page is part of a
...
public abstract class ReportPage implements ILinkable {
	...
	/** context for this org.jacoco.report */
	protected final IHTMLReportContext context;

	/**
	 * Creates a new org.jacoco.report page.
	 * 
	 * @param parent
	 *            optional hierarchical parent
	 * @param folder
	 *            base folder to create this org.jacoco.report in
	 * @param context
	 *            settings context
	 */
	...
	/**
	 * Checks whether this is the root page of the org.jacoco.report.
	 * 
	...
	protected void head(final HTMLElement head) throws IOException {
		...
		head.link("shortcut icon",
				context.getResources().getLink(folder, "org.jacoco.report.gif"),
				"image/gif");
